...
# def bq_to_df(self, project_id, dataset_id, table_id, storage_uri, local_data_path):
...
:rtype: pd.DataFrame
"""
# self.bq_to_storage(project_id, dataset_id, table_id, storage_uri)
#
# self.storage_to_local(project_id, storage_uri, local_data_path)
#
# data_dir = os.path.join(local_data_path, "test_data")
# df = self.local_to_df(data_dir)

# return df

# def bq_to_storage(self, project_id, dataset_id, table_id, target_uri):
...
# def storage_to_local(self, project_id, source_uri, target_dir):
...
# def local_to_df(self, data_path):
